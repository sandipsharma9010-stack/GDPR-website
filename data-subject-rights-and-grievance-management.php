      ...
      <div data-ns-animate data-delay="0.4"
        ...
        <div class="grid grid-cols-12 items-center xl:gap-[100px] lg:gap-20 gap-y-10">
          <div class="col-span-12 lg:col-span-6">
            <div class="space-y-8">
              <div class="space-y-2">
                <h3>Improved Efficiency and Reduced DPO Workload </h3>
                <p class="max-w-[410px] w-full">
                  Automated workflows and structured processing minimize manual intervention, accelerating responses to
          ...
          <div class="col-span-12 lg:col-span-6">
            <div class="flex items-center gap-8">
              <figure class="max-w-[233px] w-full rounded-2xl overflow-hidden">
                <img src="images/home-page-10/withdrwal.svg" alt="time increase" class="w-full" />
              </figure>
              <figure class="max-w-[350px] w-full rounded-[20px] overflow-hidden">
                <img src="images/home-page-10/right-address.svg" alt="control car" class="w-full" />
              </figure>
            </div>
          </div>
        </div>
          ...
          <div class="col-span-12 lg:col-span-6">
            <div class="flex items-center gap-8">
              <figure class="max-w-[326px] max-h-[317px] h-full w-full rounded-[20px] overflow-hidden">
                <img src="images/home-page-10/deletions-or.svg" alt="revenue"
                  class="w-full h-full object-cover dark:hidden" />
                <img src="images/home-page-10/deletions-or.svg" alt="revenue"
                  class="w-full h-full object-cover hidden dark:block" />
              </figure>
              <figure class="max-w-[255px] max-h-[178px] h-full w-full rounded-2xl overflow-hidden">
                <img src="images/home-page-10/access-request.svg" alt="balance"
                  class="w-full h-full object-cover dark:hidden" />
                <img src="images/home-page-10/access-request.svg" alt="balance"
                  class="w-full h-full object-cover hidden dark:block" />
              </figure>
            ...
            <div class="space-y-8">
              <div class="space-y-2">
                ...
                <p class="max-w-[493px] w-full">
                  Ensures adherence to GDPR requirements, including statutory deadlines, audit trails, and
            ...
            <div class="space-y-8">
              <div class="space-y-2">
                ...
                <p class="max-w-[380px] w-full">
                  Both the organization and Data Subjects can view the status of requests and complaints, promoting
                  trust and openness.
                </p>
              </div>
              <div>
          ...
          <div class="col-span-12 lg:col-span-6">
            <div class="flex items-start gap-8">
              <figure class="max-w-[350px] max-h-[345px] h-full w-full rounded-[20px] overflow-hidden">
                <img src="images/home-page-10/request-and-complaint.svg" alt="earning"
                  class="w-full h-full object-cover dark:hidden" />
                <img src="images/home-page-10/request-and-complaint.svg" alt="earning"
                  class="w-full h-full object-cover hidden dark:block" />
              </figure>
              <div class="space-y-8">
                <figure class="max-w-[286px] max-h-[190px] h-full w-full rounded-2xl overflow-hidden">
                  <img src="images/home-page-10/manage-data.svg" alt="daily payment"
                    class="w-full h-full object-cover dark:hidden" />
                  <img src="images/home-page-10/manage-data.svg" alt="daily payment"
                    class="w-full h-full object-cover hidden dark:block" />
                </figure>
          ...
          <div class="col-span-12 lg:col-span-6">
            <div class="flex items-start -space-x-20">
              <figure class="max-w-[408px] w-full rounded-[20px] overflow-hidden">
                <img src="images/services/weekly-risk.svg" alt="revenue"
                  class="w-full h-full object-cover dark:hidden" />
                <img src="images/services/weekly-risk.svg" alt="revenue"
                  class="w-full h-full object-cover hidden dark:block" />
              </figure>
              <figure class="max-w-[225px] w-full rounded-2xl overflow-hidden mt-4">
                <img src="images/services/last-resloved.svg" alt="balance"
                  class="w-full h-full object-cover dark:hidden" />
                <img src="images/services/last-resloved.svg" alt="balance"
                  class="w-full h-full object-cover hidden dark:block" />
              </figure>
          ...
          <div class="col-span-12 lg:col-span-6">
            <div class="space-y-8">
              <div class="space-y-2">
                ...
                <p class="max-w-[493px] w-full">
                  Timely resolution of rights requests and complaints significantly reduces the risk of regulatory
      ...
      <div data-ns-animate data-delay="0.6"
        ...
        <div class="grid grid-cols-12 items-center xl:gap-[100px] lg:gap-20 gap-y-10">
          <div class="col-span-12 lg:col-span-6">
            <div class="space-y-8">
              <div class="space-y-2">
                <h3>Customer Trust & Satisfactio</h3>
                <p class="max-w-[380px] w-full">
                  By enabling Data Subjects to easily exercise their rights and track their requests, organizations
                  demonstrate a strong commitment to privacy, enhancing customer loyalty.
                </p>
              </div>
              <div>
                <a href="./our-services-details-page.html"
          ...
          <div class="col-span-12 lg:col-span-6">
            <div class="flex items-start gap-8">
              <figure class="max-w-[350px] max-h-[345px] h-full w-full rounded-[20px] overflow-hidden">
                <img src="images/home-page-10/withdwral-request5.svg" alt="earning"
                  class="w-full h-full object-cover dark:hidden" />
                <img src="images/home-page-10/withdwral-request5.svg" alt="earning"
                  class="w-full h-full object-cover hidden dark:block" />
              </figure>
              <div class="space-y-8">
                <figure class="max-w-[286px] max-h-[190px] h-full w-full rounded-2xl overflow-hidden">
                  <img src="images/home-page-10/grivence-request.svg" alt="daily payment"
                    class="w-full h-full object-cover dark:hidden" />
                  <img src="images/home-page-10/grivence-request.svg" alt="daily payment"
                    class="w-full h-full object-cover hidden dark:block" />
                </figure>
