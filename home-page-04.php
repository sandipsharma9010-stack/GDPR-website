...
/>
    ...
    <title>Web Hosting - NextSaaS</title>
...
<header
  ...
  data-direction="up"
  data-offset="100"
  class="opacity-0 fixed top-0 left-0 right-0 bg-white dark:bg-background-5 border-b border-stroke-2 dark:border-stroke-6 px-5 xl:py-0 py-5 flex items-center z-10 {=$class}"
>
  <div class="header-three max-w-[1920px] mx-auto w-full flex items-center justify-between px-6">
    <div>
      <a href="./" class="hidden md:inline-block">
        ...
        <img src="./images/shared/main-logo.svg" class="block dark:hidden" alt="NextSass" />
        <img src="./images/shared/dark-logo.svg" class="hidden dark:block" alt="NextSass" />
      </a>
      <a href="./" class="inline-block md:hidden">
        <span class="sr-only">Home</span>
        <img src="./images/shared/logo.svg" class="block dark:hidden" alt="NextSass" />
        <img src="./images/shared/logo-dark.svg" class="hidden dark:block" alt="NextSass" />
      </a>
    </div>
    <div class="flex items-center gap-[76px]">
      <nav class="hidden xl:flex items-center">
        <ul class="flex items-center gap-6">
          <li class="relative nav-item cursor-pointer py-6" data-menu="home-mega-menu">
            <a href="#" class="nav-item-link-border">
              <span>Home</span>
              <span class="nav-arrow transition-all duration-200">
                <svg
                ...
                >
                  <path
                    d="M4.30469 8L8.30469 12L12.3047 8"
                    class="stroke-secondary/60 group-hover/nav:stroke-secondary dark:stroke-accent/60 group-hover/nav:dark:stroke-accent transition-all duration-200"
                    stroke-width="1.5"
...
<div>
  ...
  <div
    id="home-mega-menu"
    class="mega-menu fixed mt-2 left-1/2 -translate-x-1/2 top-full pointer-events-none transition-all duration-300 opacity-0 bg-white rounded-[20px] z-50 max-w-[1290px] w-full overflow-hidden dark:bg-background-6 shadow-1 border dark:border-background-5 border-stroke-4 {=$mega-menu-color}"
  >
        ...
        <ul class="space-y-5 pr-4">
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>05. Analytics &amp; Reporting</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>06. Financial Aplication</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>07. Payment Solutions</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>09. Cloud Based Software</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
        ...
        <ul class="space-y-5 px-4">
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>13. Messaging Platform</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>14. Mortgage Services</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>15. Creative Portfoilo</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>20. Risk Management Software</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>22. Mobile Management Software</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>23. Investment Management</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
        ...
        <ul class="space-y-5 pl-4">
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>24. Insurance Software</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>25. Property Management</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>27. Social Media Management</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>29. Wealth Management</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>30. Security Software</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>32. Data Visualization</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>33. Digital Marketing Agency</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>35. Decentralized Finance</span>
              <span
                class="group-hover/item:translate-x-2 group-hover/item:opacity-100 opacity-0 transition-all duration-200"
              >
                <svg
...
<div>
  <!-- Transparent bridge to prevent gap -->
  <div
    class="mega-menu-bridge fixed left-1/2 -translate-x-1/2 top-full w-full h-6 bg-transparent z-40 max-w-[1290px] pointer-events-none"
  ></div>
  <div
    id="pages-mega-menu"
    class="mega-menu fixed left-1/2 -translate-x-1/2 top-full mt-2 pointer-events-none transition-all duration-300 opacity-0 bg-white rounded-[20px] z-50 max-w-[1290px] w-full shadow-1 border dark:border-background-5 border-stroke-4 overflow-hidden dark:bg-background-6 {=$mega-menu-color}"
  >
    <div class="flex w-full relative">
      <div class="flex justify-between flex-1 gap-10 px-[60px] py-[70px]">
        <ul class="max-w-[182px] w-full space-y-5 pr-4">
          <li>
            <a
              href="./learn-page.html"
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>Tutorial Page</span>
              <!-- =========================
Link Icon
===========================-->
<span
...
>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    />
        ...
        <div class="w-px h-full bg-secondary/10 dark:bg-accent/10"></div>
        <ul class="max-w-[182px] w-full space-y-5 pl-4">
          <li>
            <a
              href="./features-page-01.html"
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>Features Page 01</span>
              <!-- =========================
Link Icon
===========================-->
<span
...
>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    />
          ...
          <li>
            <a
              href="./affiliate-policy-page.html"
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>Affiliate Policy</span>
              <!-- =========================
Link Icon
===========================-->
<span
...
>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    />
        ...
        <div class="w-px h-full bg-secondary/10 dark:bg-accent/10"></div>
        <ul class="max-w-[200px] w-full space-y-5 px-4">
          <li>
            <a
              href="./testimonial-page-01.html"
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>Testimonials Page 01</span>
              <!-- =========================
Link Icon
===========================-->
<span
    ...
    />
          ...
          <li>
            <a
              ...
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
              <span>Testimonials Page 02</span>
              <!-- =========================
Link Icon
===========================-->
<span
...
>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    />
          ...
          <li>
            <a
              href="./case-study-details-page.html"
              class="text-secondary/60 dark:text-accent/60 dark:hover:text-accent flex items-center gap-1 group/item font-normal text-tagline-1 hover:text-secondary transition-all duration-200"
            >
...
>
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    />
          ...
          <li class="relative nav-item cursor-pointer py-6" data-menu="about-menu">
            <a href="#" class="nav-item-link-border">
              <span>About</span>
              <span
                class="nav-arrow block origin-center transition-all duration-300 translate-y-px"
...
<div class="">
  ...
  <div
    id="about-menu"
    class="dropdown-menu absolute left-1/2 -translate-x-1/2 top-full mt-2 pointer-events-none transition-all duration-300 opacity-0 bg-white dark:bg-background-6 rounded-[20px] px-[60px] py-[70px] z-50 min-w-[280px] w-full overflow-hidden {=$class} border border-stroke-1 dark:border-stroke-6"
  >
    <ul class="w-full space-y-5">
      ...
      <li>
        ...
        >
          ...
          <li class="relative nav-item cursor-pointer py-6" data-menu="services-menu">
            <a href="#" class="nav-item-link-border">
              <span>Services</span>
              <span
                class="nav-arrow block origin-center transition-all duration-300 translate-y-px"
    ...
    <ul class="w-full space-y-5">
      ...
      <li>
        ...
        >
          ...
          <li class="py-6">
            <a href="./contact-us-page.html" class="nav-item-link-border"> Contact Us </a>
          </li>
        </ul>
      </nav>
      <div class="flex items-center gap-2">
        <div class="sm:block hidden">
          <a href="./signup-page-01.html" class="btn btn-md btn-primary hover:btn-white-dark dark:hover:btn-white">
            <span>Get started</span>
          </a>
        </div>
        <div class="xl:hidden block">
          <button
            class="nav-hamburger flex flex-col gap-1.5 size-12 bg-background-4 dark:bg-background-7 rounded-full items-center justify-center cursor-pointer"
          >
...
>
  ...
  >
    <img
      src="./images/home-page-4/web-host-hero-pattern.png"
        ...
        <div class="text-center xl:text-left relative z-[1]">
          ...
          <div class="mt-5 mb-14 space-y-4 max-w-[800px] xl:max-w-full mx-auto xl:mx-0">
            <h1 data-ns-animate data-delay="0.2" class="opacity-0">
              Fastest web hosting performance
            </h1>
            <p data-ns-animate data-delay="0.3" class="opacity-0">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem ccusantium doloremque
              laudantium, totam rem aperiam inventore.
            </p>
          </div>
          <form
            data-ns-animate
          ...
          >
            ...
            >
              ...
              <p class="text-tagline-3 dark:text-accent/60">Customers across the globe</p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-span-12 xl:col-span-6 relative z-[1]">
        <figure class="max-w-[679px] mx-auto xl:mx-0 mt-12 relative xl:-mt-20">
          <img
            ...
            data-delay="0.5"
            data-direction="up"
            src="./images/home-page-4/hero-img.png"
            alt="web hosting hero"
          ...
          >
            <figure>
              <img
                src="./images/home-page-4/hero-chart.png"
                alt="web hosting hero"
                class="w-full h-full block dark:hidden"
              />
              <img
                src="./images/home-page-4/hero-chart-dark.png"
                alt="web hosting hero"
      ...
      <div>
        <div class="xl:p-[70px] p-5 sm:p-10">
          <h3 data-ns-animate data-delay="0.1" class="text-white max-w-[571px] mx-auto">
            Discover the ideal domain name for your business
          </h3>
          <form
            data-ns-animate
            data-delay="0.2"
        ...
        <div class="xl:p-[70px] p-5 sm:p-10 space-y-3">
          ...
          >
            ...
            <span class="xl:text-tagline-1 text-tagline-2 text-accent/60">436 reviews on</span>
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="17"
            ...
            <span class="xl:text-tagline-1 text-tagline-2 text-accent/60">Trustpilot</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-12 xl:items-start items-center xl:gap-[100px] gap-y-[100px]">
      <div class="col-span-12 xl:col-span-6">
        <div class="xl:max-w-full max-w-[600px] mx-auto xl:mx-0 text-center xl:text-left">
          ...
          <div class="mt-5 space-y-3 mb-8">
            <h2 data-ns-animate data-delay="0.2">Genuine solutions for authentic web hosting</h2>
            <p data-ns-animate data-delay="0.3" class="max-w-[450px] mx-auto xl:mx-0">
              Genuine solutions for authentic web hosting prioritize reliability, transparency, and
      ...
      <div class="col-span-12 xl:col-span-6">
        <figure data-ns-animate data-delay="0.7" class="max-w-[592px] mx-auto w-full">
          <img src="images/home-page-4/company.png" alt="solutions-01" class="w-full dark:hidden" />
          <img
            src="images/home-page-4/company-dark.png"
            alt="solutions-01"
...
===========================-->
<section
  class="xl:py-[100px] md:py-20 py-14 bg-background-2 dark:bg-background-5 xl:space-y-[100px] md:space-y-20 space-y-14 overflow-hidden"
>
  <div class="main-container">
    <div class="max-w-[650px] mx-auto w-full text-center">
      <span data-ns-animate data-delay="0.1" class="badge badge-cyan">Our Services</span>
      <h2 data-ns-animate data-delay="0.2" class="mb-3 mt-4">
        In-depth overview of cryptocurrency solutions
      </h2>
      <p data-ns-animate data-delay="0.3">
        An in-depth overview of cryptocurrency solutions reveals a rapidly evolving ecosystem
        designed to revolutionize traditional financial systems.
      </p>
    </div>
  </div>
  <div class="main-container xl:pb-20">
    <div
      class="grid grid-cols-12 items-center justify-center xl:justify-start xl:gap-[100px] gap-y-14"
    >
      <div class="col-span-12 xl:col-span-6">
        <figure
          data-ns-animate
          ...
          data-direction="right"
          data-offset="50"
          class="max-w-[595px] max-h-[480px] mx-auto xl:mx-0"
        >
          <img
            src="./images/home-page-4/services-1.png"
            alt="services-1"
            class="w-full h-full object-fill dark:hidden"
          />
          <img
            src="./images/home-page-4/services-1-dark.png"
            alt="services-1"
            class="w-full h-full object-fill hidden dark:block"
          />
        </figure>
      </div>
      <div class="col-span-12 xl:col-span-6">
        <div class="text-center xl:text-left">
          <div class="space-y-3 mb-14">
            <h3 data-ns-animate data-delay="0.5" class="max-w-[509px] mx-auto xl:mx-0">
              Monitor and analyze conversions effectively
            </h3>
            <p data-ns-animate data-delay="0.6" class="max-w-[465px] mx-auto xl:mx-0">
              Monitoring and analyzing conversions effectively is essential for understanding how
              users interact with your digital platforms
            </p>
          </div>
          <div data-ns-animate data-delay="0.7">
            <a
              href="./services-page-01.html"
              class="btn btn-secondary dark:btn-accent hover:btn-primary btn-md"
            >
              <span>Read More</span>
            </a>
          </div>
  ...
  <div class="main-container xl:pb-14">
    <div class="grid grid-cols-12 items-center xl:gap-[100px] gap-y-14">
      <div class="col-span-12 xl:col-span-6 xl:order-1 order-2">
        <div class="text-center xl:text-left">
          <div class="space-y-3 mb-14">
            <h3 data-ns-animate data-delay="0.1" class="max-w-[509px] mx-auto xl:mx-0">
              Instantaneous data insights and analytics
            </h3>
            <p data-ns-animate data-delay="0.2" class="max-w-[465px] mx-auto xl:mx-0">
              Instantaneous data insights and analytics refer to the real-time processing and
      ...
      <div class="col-span-12 xl:col-span-6 xl:order-2 order-1">
        <div class="flex gap-8 flex-row items-center justify-center xl:justify-start">
          <figure
            data-ns-animate
            data-delay="0.4"
            data-direction="up"
            class="max-w-[350px] w-full xl:h-[345px] h-auto rounded-[20px] overflow-hidden"
          >
            <img
              src="./images/home-page-4/services-2.png"
              alt="services-2"
              class="w-full h-full object-fill dark:hidden"
            />
            <img
              src="./images/home-page-4/services-2-dark.png"
              alt="services-2"
              class="w-full hidden dark:block"
            />
          </figure>
          <div class="space-y-8 xl:mt-12 mt-6">
            <figure
              data-ns-animate
              data-delay="0.5"
              class="max-w-[233px] w-full xl:h-[186px] h-auto rounded-[20px] overflow-hidden"
            >
              <img
                src="./images/home-page-4/services-3.png"
                alt="services-3"
                class="w-full h-full object-cover dark:hidden"
              />
              <img
                src="./images/home-page-4/services-3-dark.png"
                alt="services-3"
                class="size-full hidden object-cover dark:block"
              />
            </figure>
            <div data-ns-animate data-delay="0.6" class="flex space-y-4 flex-col">
              <div class="flex -space-x-3.5">
                <img
                  data-ns-animate
                  data-delay="0.7"
                  data-direction="right"
                  class="inline-block size-11 rounded-full ring-4 ring-white dark:ring-black bg-linear-[156deg,#FFF_32.92%,#A585FF_91%]"
                  src="images/avatar/avatar-1.png"
                  alt="Avatar 1"
                />
                <img
                  ...
                  data-delay="0.8"
                  data-direction="right"
                  class="size-11 rounded-full ring-4 ring-white dark:ring-black bg-linear-[156deg,#FFF_32.92%,#A585FF_91%] hidden sm:inline-block"
                  src="images/avatar/avatar-2.png"
                  alt="Avatar 2"
                />
                <img
                  ...
                  data-delay="0.9"
                  data-direction="right"
                  class="inline-block size-11 rounded-full relative z-0 ring-4 ring-white dark:ring-black bg-linear-[156deg,#FFF_32.92%,#A585FF_91%]"
                  src="images/avatar/avatar-3.png"
                  alt="Avatar 3"
                />
                <div
                  ...
                  data-delay="1"
                  data-direction="right"
                  class="inline-flex items-center relative z-10 justify-center size-11 bg-ns-green rounded-full ring-4 ring-white dark:ring-black text-secondary/80 text-tagline-3 font-medium"
                >
                  99+
                </div>
              </div>
              <div data-ns-animate data-delay="1.1">
                <p class="text-heading-6 font-normal text-secondary dark:text-accent">
                  Trusted by 20k+
                </p>
                <p class="text-tagline-2">Customers across the globe</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="main-container">
    <div class="grid grid-cols-12 items-center xl:gap-[100px] gap-y-14">
      <div class="col-span-12 xl:col-span-6">
        <div class="relative max-w-[595px] mx-auto xl:mx-0 w-full">
          <figure
            data-ns-animate
            data-delay="0.5"
            data-direction="left"
            data-offset="100"
            class="absolute bottom-10 xl:-left-12 left-2.5 z-[1] min-w-[288px] space-y-2 shadow-1 bg-white dark:bg-background-6 rounded-xl p-4 min-h-[100px] max-h-[101px]"
          >
            <figcaption class="flex justify-between gap-2">
              <span class="text-tagline-1 font-normal dark:text-accent"> Today's Revenue </span>
              <span
                class="text-lg flex items-center font-medium leading-[1.5] text-secondary dark:text-accent"
              >
                <span class="font-inherit"> $ </span>
                <span
                  data-counter
            ...
            <div
              ...
              role="status"
              aria-label="Credit limit usage"
            >
              <span
                class="relative max-w-[229px] inline-block bg-secondary dark:bg-accent w-full h-1.5 rounded-full"
              >
                <span
                  data-progress-bar
                  data-progress-duration="2"
                  class="bg-ns-green w-0 h-full rounded-full absolute top-0 left-0"
                ></span>
              </span>
              <span data-progress-text class="text-tagline-3 font-normal dark:text-accent"
                >88%</span
              >
            </div>
          </figure>
          ...
          <figure
            ...
            data-direction="up"
            data-offset="100"
            class="max-w-[413px] mx-auto xl:mx-0 w-full max-h-[995px] rounded-[20px] overflow-hidden"
          >
            <img
              src="./images/home-page-4/services-4.png"
              alt="services-4"
              class="size-full object-cover dark:hidden"
            />
            <img
              src="./images/home-page-4/services-4-dark.png"
              alt="services-4"
          ...
          <figure
            ...
            data-direction="right"
            data-offset="100"
            class="absolute xl:bottom-10 xl:right-20 right-0 rounded-xl overflow-hidden -bottom-8 z-[1] shadow-9 hidden sm:block"
          >
            <img
              src="./images/home-page-4/balance.svg"
              alt="balance"
              class="w-full h-full dark:hidden"
            />
            <img
              src="./images/home-page-4/balance-dark.svg"
              alt="balance"
              class="w-full h-full hidden dark:block"
            />
          </figure>
      ...
      <div class="col-span-12 xl:col-span-6">
        <div class="text-center xl:text-left">
          <div class="space-y-3 mb-14">
            <h3 data-ns-animate data-delay="0.1" class="max-w-[509px] mx-auto xl:mx-0">
              Sales strategy and management techniques
            </h3>
            <p data-ns-animate data-delay="0.2" class="max-w-[465px] mx-auto xl:mx-0">
              Sales strategy and management techniques are essential components for driving business
              growth and achieving revenue targets.
            </p>
          </div>
          <div data-ns-animate data-delay="0.3">
            <a
...
Pricing section
===========================-->
<section class="xl:py-[120px] md:py-20 py-14">
  <div
    class="max-w-[1440px] mx-auto space-y-[70px] xl:py-[120px] py-20 xl:px-16 px-8 bg-background-2 dark:bg-background-5 xl:rounded-[32px] rounded-[20px]"
  >
    <div class="max-w-2xl mx-auto text-center space-y-3">
      <span data-ns-animate data-delay="0.1" class="badge badge-cyan">Our pricing</span>
      <h2 data-ns-animate data-delay="0.2">Select the pricing plan that best suits your needs.</h2>
    </div>
    <div class="grid grid-cols-12 xl:gap-8 md:gap-6 gap-y-5">
      <div data-ns-animate data-delay="0.3" class="col-span-12 xl:col-span-3 md:col-span-6">
        <div>
          <div class="xl:h-[195px] w-[290px]"></div>
          <div class="space-y-2.5">
            <h3 class="text-heading-6">What’s included</h3>
            <ul>
              <li
                class="text-secondary/60 text-tagline-1 font-normal py-4 pr-6 border-b border-b-stroke-4 dark:border-b-stroke-5 dark:text-accent/60"
              >
                Pages included
              </li>
              <li
              ...
              <li class="text-secondary/60 text-tagline-1 font-normal py-4 pr-6">
      ...
      <div data-ns-animate data-delay="0.4" class="col-span-12 xl:col-span-3 md:col-span-6">
        <div>
          <div
            class="rounded-[20px] dark:rounded-b-none dark:rounded-t-[20px] py-8 px-6 bg-background-3 dark:bg-background-7 space-y-8"
          >
            <div>
              <p class="text-tagline-1 font-medium mb-3">Essential</p>
              <h3 class="text-heading-5 font-normal">Free</h3>
              <p>Free plan for all users</p>
            </div>
            <a
              href="./pricing-page-01.html"
              class="btn btn-white dark:btn-white-dark hover:btn-secondary dark:hover:btn-white btn-md w-full before:content-none first-letter:uppercase"
            >
              Get started
            </a>
          </div>
          <div
            class="rounded-[20px] dark:rounded-b-[20px] dark:rounded-t-none bg-background-1 dark:bg-background-6"
          >
            <ul>
              <li
                class="h-14 px-6 py-4 text-center border-b border-b-stroke-4 dark:border-b-stroke-5"
              >
                <p class="font-medium">Up to 5</p>
              </li>
              <li
                class="h-14 px-6 py-4 text-center border-b border-b-stroke-4 dark:border-b-stroke-5 flex items-center justify-center"
              >
                <svg
                  width="20"
                  height="20"
      ...
      <div data-ns-animate data-delay="0.5" class="col-span-12 xl:col-span-3 md:col-span-6">
        <div>
          <div
            class="rounded-[20px] dark:rounded-b-none dark:rounded-t-[20px] z-10 relative py-8 px-6 bg-secondary space-y-8 overflow-hidden"
          >
            <div
              class="absolute h-full w-full -top-28 -right-20 -z-1 select-none pointer-events-none"
            >
              <img src="./images/gradient/gradient-4.png" alt="pricing bg" />
            </div>
            <div>
              <p class="text-tagline-1 text-accent/60 font-medium mb-3">Advanced</p>
              <h3 class="text-heading-5 font-normal text-accent">$99</h3>
              <p class="text-accent/60">Plans for advanced users</p>
            </div>
            <a
              href="./pricing-page-01.html"
              class="btn btn-primary hover:btn-white dark:hover:btn-white btn-md w-full !border-none before:content-none first-letter:uppercase"
              >Get started</a
            >
          </div>
          <div
          ...
          >
            <ul>
              <li
                class="h-14 px-6 py-4 text-center border-b border-b-stroke-4 dark:border-b-stroke-5"
              >
                <p class="font-medium">Up to 10</p>
              </li>
              <li
                class="h-14 px-6 py-4 text-center border-b border-b-stroke-4 dark:border-b-stroke-5 flex items-center justify-center"
              >
      ...
      <div data-ns-animate data-delay="0.6" class="col-span-12 xl:col-span-3 md:col-span-6">
        <div>
          <div
            class="rounded-[20px] dark:rounded-b-none dark:rounded-t-[20px] py-8 px-6 bg-background-3 dark:bg-background-7 space-y-8"
          >
            <div>
              <p class="text-tagline-1 font-medium mb-3">Enterprise</p>
              <h3 class="text-heading-5 font-normal">Enterprise</h3>
          ...
          >
            <ul>
              ...
              <li class="h-14 px-6 py-4 text-center flex items-center justify-center">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
...
Reviews section
===========================-->
<section class="xl:py-[100px] md:py-20 py-14 space-y-[70px]">
  <div class="main-container">
    <div class="space-y-5 max-w-[804px] mx-auto text-center">
      <span data-ns-animate data-delay="0.1" class="badge badge-cyan">Reviews</span>
      <div class="space-y-3">
  ...
  <div>
    <div data-ns-animate data-delay="0.4" class="cards-marquee-container">
      <div class="flex items-center gap-8">
        <div
          class="bg-background-1/90 hover:bg-white dark:bg-background-5 dark:hover:bg-background-8 hover:shadow-1 transition-colors duration-300 ease-linear rounded-[20px] p-8 min-w-[358px] max-w-[358px] shrink-0 w-full ml-8"
        >
          <p class="text-wrap">
            Amazing customer support and powerful featurres-Nuvio has transformed the way we manage
            our workflows!
          </p>
          <div class="my-8 h-px w-full bg-stroke-4 dark:bg-stroke-8"></div>
            ...
            <div class="flex items-center gap-3">
              <figure class="size-12 rounded-full overflow-hidden">
                <img
                  src="./images/avatar/avatar-1.png"
                  alt="avatar"
                  class="h-full w-full bg-linear-[156deg,#83E7EE_2.92%,#C6F56F_91%]"
                />
              </figure>
              <div>
                <h3 class="text-tagline-1 font-medium text-secondary dark:text-accent">
                  Sarah Johnson
                </h3>
                <p class="text-tagline-2 text-secondary/60 font-normal dark:text-accent/60">
                  CEO, Nuvio
                </p>
              </div>
            </div>
        ...
        <div
          class="bg-background-1/90 hover:bg-white dark:bg-background-5 dark:hover:bg-background-8 hover:shadow-1 transition-colors duration-300 ease-linear rounded-[20px] p-8 min-w-[358px] max-w-[358px] shrink-0 w-full"
        >
          <p class="text-wrap">
            Amazing customer support and powerful featurres-Nuvio has transformed the way we manage
            our workflows!
    ...
    <div class="space-y-5 max-w-[804px] mx-auto text-center">
      ...
      <div class="space-y-3 text-center">
        ...
        <p data-ns-animate data-delay="0.3" class="max-w-[802px] mx-auto">
          The operation of instantaneous data insights and analytics involves several key steps. It
          begins with data collection, where information is gathered in real-time from various
          sources such as sensors
        </p>
      </div>
    </div>
    ...
    <div class="grid grid-cols-12 items-center xl:gap-[100px] gap-y-14">
      <div class="col-span-12 xl:col-span-5">
        <div>
          ...
          >
            <img
              src="./images/home-page-4/process.png"
              alt="process"
              class="h-full w-full dark:hidden"
            />
            <img
              src="./images/home-page-4/process-dark.png"
              alt="process"
      ...
      <div class="col-span-12 xl:col-span-7">
        <div class="flex flex-col gap-y-5 items-center">
          ...
          >
            ...
            <div class="space-y-1">
              <h3 class="text-lg font-medium leading-[27px] text-scondary">Choose domain</h3>
              <p>
                Choose a domain name that reflects your website's purpose, content, or the nature of
                your business.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="space-y-1">
              <h3 class="text-lg font-medium leading-[27px] text-scondary">Login/register</h3>
              <p>
                Take the first step towards creating your website and reaching a wider audience by
                registering today.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="space-y-1">
              <h3 class="text-lg font-medium leading-[27px] text-scondary">Make payment</h3>
              <p>
                We offer a variety of secure payment methods to make your payment process convenient
                and hassle-free.
              </p>
            </div>
          </div>
...
<section class="xl:py-[100px] md:py-20 py-14">
  <div class="main-container">
    <div class="text-center mb-[70px] space-y-5">
      <span data-ns-animate data-delay="0.1" class="badge badge-cyan">Blog</span>
      <div class="space-y-3">
        <h2 data-ns-animate data-delay="0.2">Our recent news & insights</h2>
    ...
    <div class="grid grid-cols-12 xl:gap-8 md:gap-6 gap-y-6 items-start">
      <!-- Blog Card 1 -->
      <article data-ns-animate data-delay="0.4" class="col-span-12 md:col-span-6 xl:col-span-4">
        <div
          class="bg-background-1 dark:bg-background-6 rounded-[20px] overflow-hidden relative md:min-h-[552px] hscale-100 hover:scale-[102%] transition-transform duration-500 hover:transition-transform hover:duration-500"
        >
          <figure class="md:min-h-[260px]">
            <img
              src="images/blogs/blog-39.png"
          ...
          <div class="sm:p-6 p-4 space-y-6">
              ...
              <div class="flex items-center gap-2.5">
                ...
                <span>
                  <svg
                    ...
                    fill="none"
                  >
                    <circle cx="2.5" cy="2.5" r="2.5" fill="#ECE8FF" />
                  </svg>
                </span>
                <time
                  datetime="2025-03-20"
            ...
            <div>
              <a
                href="./blog-details-page.html"
                class="btn btn-md btn-white hover:btn-secondary dark:hover:btn-accent inline-block dark:btn-white-dark"
      ...
      <!-- Blog Card 2 -->
      <article data-ns-animate data-delay="0.5" class="col-span-12 md:col-span-6 xl:col-span-4">
        <div
          class="bg-background-1 dark:bg-background-6 rounded-[20px] overflow-hidden relative md:min-h-[552px] hscale-100 hover:scale-[102%] transition-transform duration-500 hover:transition-transform hover:duration-500"
        >
          <figure class="md:min-h-[260px]">
            <img
              src="images/blogs/blog-40.png"
      ...
      <!-- Blog Card 3 -->
      <article data-ns-animate data-delay="0.6" class="col-span-12 md:col-span-6 xl:col-span-4">
        <div
          class="bg-background-1 dark:bg-background-6 rounded-[20px] overflow-hidden relative md:min-h-[552px] hscale-100 hover:scale-[102%] transition-transform duration-500 hover:transition-transform hover:duration-500"
        >
          <figure class="md:min-h-[260px]">
            <img
              src="images/blogs/blog-41.png"
...
===========================-->
<footer
  class="footer footer-three bg-white dark:bg-background-8 rounded-t-[20px] relative overflow-hidden relative overflow-hidden"
>
  <div class="main-container">
    <!-- footer bg-img  -->
    ...
    <figure
      ...
      data-offset="100"
      data-direction="right"
      class="footer-gradient-visible absolute overflow-hidden hidden show-gradient !block size-[600px] md:size-[1220px] rotate-[-38deg] right-[-321px]  md:right-[-693px] top-[-237px] md:top-[-485px] select-none pointer-events-none"
    >
      <img src="./images/gradient/gradient-36.png" alt="gradient-img" class="w-full h-full object-cover" />
    </figure>
