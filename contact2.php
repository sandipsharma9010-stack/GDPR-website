...
?>
    ...
    <div name="divotp" id="divotp" href="divotp">
        ...
        >
          <form xclass="needs-validation" action="#divotp" method="post" id="mainForm" xnovalidate  enctype="multipart/form-data" class="space-y-8">
        ...
        <input type="text" name="job" value="<?=$job;?>" style="display:none" />
            <div class="flex items-center flex-col md:flex-row gap-8 justify-between">
              ...
              <div class="space-y-2 lg:max-w-[364px] w-full">
                 <label for="name" class="form-label block text-tagline-2 text-secondary dark:text-accent font-medium">Full Name</label>
                <input
                  type="text"  placeholder="Full Name" name="fullname" value="<?php echo $fullname; ?>" required 
            ...
            <!-- email  -->
            <div class="space-y-2">
              <label for="email" class="form-label block text-tagline-2 text-secondary dark:text-accent font-medium">Email</label>
              
              <input
                type="email" placeholder="Email" name="emailadd"
            ...
            <!-- subject  -->
            <div class="space-y-2">
              <label for="contact_topic" class="form-label block w-100 text-tagline-2 text-secondary dark:text-accent font-medium">Select a Topic:</label>
              
              <select id="contact_topic" name="contact_topic" class="form-control form-select w-full px-[18px] dark:focus-visible:border-stroke-4/20 dark:border-stroke-7 py-3 h-[48px] xl:h-[41px] rounded-full dark:bg-background-6 border border-stroke-3 bg-background-1 text-tagline-2 placeholder:text-secondary/60 focus:outline-none focus:border-secondary placeholder:text-tagline-2 dark:placeholder:text-accent/60 dark:text-accent placeholder:font-normal font-normal">
            ...
            <div class="space-y-2">
             ...
             <label for="message" class= "form-label w-100 block text-tagline-2 text-secondary dark:text-accent font-medium">Your Message:</label>
            ...
            <?php if($act=='newsletter') { ?> <input type="hidden" name="contact_topic" value="newsletter" /> <?php } ?>
                    ...
                    <?php if($_POST) { ?>
                      ...
                      <label for="totp" class="form-label" id="lotp">Enter your OTP shared over Email </label>
                        ...
                        <div class="text-center">
                            <input type="submit" name="submit" id="submitbtn" value="Submit" class="bg-gray-[200px]!important text-black font-medium rounded-lg shadow-md px-6 py-2" />
                        </div>
